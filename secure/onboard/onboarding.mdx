...
<Tabs>
  <Tab title="AWS">
    ...
    <Accordion title="See an Example of the Health Status for CSPM" icon="circle-question">
      | **CSPM Status**       | **Description**                                             | --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | | ✅ **Healthy**         | The account has been successfully connected, and all the resources have been scanned.                                                            | **! Needs Attention** | Some features are not working properly.                     | ❌ **Error**           | Authentication errors. For example:
