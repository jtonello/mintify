...
description: "This topic describes how to connect your AWS, Azure, GCP and OCI environments to Sysdig Secure. You can connect Single Accounts or entire Organization Accounts using Terraform or CloudFormation."
icon: "cloud"
---
