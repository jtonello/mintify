...
description: "This topic describes how to connect your AWS, Azure, GCP and OCI environments to Sysdig Secure. Click the tabs to select the platform you want to set up. You can connect Single Accounts or entire Organization Accounts using Terraform or CloudFormation."
icon: "cloud"
---
