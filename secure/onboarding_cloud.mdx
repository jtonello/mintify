...
<Tabs>
  <Tab title="AWS" icon="/images/mark-aws_bw.svg">
    # AWS
...
<TerraformSnippet/>
  ...
  <Tab title="Azure" icon="/images/mark-azure_bw.svg"> 
    # Azure
  ...
  <Tab title="GCP" icon="/images/mark-gcp_bw.svg">
    # GCP
  </Tab>
  <Tab title="OCI" icon="/images/cloud_bw.svg">
    # OCI
  </Tab>
</Tabs>