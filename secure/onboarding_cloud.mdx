...
<Tabs>
  <Tab title="AWS" icon="/images/mark-aws.svg">
    # AWS
...
<TerraformSnippet/>
  ...
  <Tab title="Azure" icon="/images/mark-azure.svg"> 
    # Azure
  ...
  <Tab title="GCP" icon="/images/mark-gcp.svg">
    # GCP
  </Tab>
  <Tab title="OCI" icon="/images/cloud.svg">
    # OCI
  </Tab>
</Tabs>