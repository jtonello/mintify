...
| Access   | Description                                      |
| -------- | -------------------------------------------------|
| [https://docs.aws.amazon.com/aws-managed-policy/latest/reference/IAMFullAccess.html](IAMFullAccess) | Required to create IAM Roles and associated permissions. |
| [https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSOrganizationsReadOnlyAccess.html](AWSOrganizationsReadOnlyAccess) | Required to list Accounts and OUIDs in your Organization. |
| [https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSCloudFormationFullAccess.html](AWSCloudFormationFullAccess) | Required to create a CloudFormation StackSet that creates IAM roles in each Account in your Organization. |
