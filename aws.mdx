...
<Accordion title="Click to Learn More About IAM Permissions">
  ...
  AWSOrganizationsReadOnlyAccess</a>
   ...
   <td>
  Required to list Accounts and OUIDs in your Organization.</td>
  ...
  AWSCloudFormationFullAccess</a>
   ...
   <td>
  Required to create a CloudFormation StackSet that creates IAM roles in each Account in your Organization.</td>
