...
| Access   | Description                                      |
| -------- | -------------------------------------------------|
| <a href="https://docs.aws.amazon.com/aws-managed-policy/latest/reference/IAMFullAccess.html">IAMFullAccess</a> | Required to create IAM Roles and associated permissions. |
| <a href="https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSOrganizationsReadOnlyAccess.html">AWSOrganizationsReadOnlyAccess</a> | Required to list Accounts and OUIDs in your Organization. |
| <a href="https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSCloudFormationFullAccess.html">AWSCloudFormationFullAccess</a> | Required to create a CloudFormation StackSet that creates IAM roles in each Account in your Organization. |
