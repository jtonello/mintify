...
<div style="font-size: 24px; line-height: 140%;">This topic describes how to connect your AWS environment to Sysdig Secure. You can connect Single Accounts or entire Organization Accounts using Terraform or CloudFormation.</div>
...
::: details Click to Learn More About Using Terraform
  - For Terraform, use the command line to export your AWS keys, or see the [AWS Terraform Provider documentation](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#authentication-and-configuration){target="_blank"} for other ways to authenticate.
...
If you're using [AWS CLI](https://aws.amazon.com/cli/){target="_blank"}, edit the `/home/user/.aws/credentials` file:
```
[default]
...
::: details Click to Learn More About IAM Permissions
<table>
    <tr>
        <td align="center" colspan="2"><b>Single Account Installations Policy</b></td>
    </tr>
    <tr>
        <td><a href="https://docs.aws.amazon.com/aws-managed-policy/latest/reference/IAMFullAccess.html" target="_blank">IAMFullAccess</a></td>
    ...
    <tr>
        <td><a href="https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSOrganizationsReadOnlyAccess.html" target="_blank">AWSOrganizationsReadOnlyAccess</a></td>
        <td>Required to list Accounts and OUIDs in your Organization.</td>
    </tr>
    <tr>
        <td><a href="https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSCloudFormationFullAccess.html" target="_blank">AWSCloudFormationFullAccess</a></td>
...
::: details See an Example of the Health Status for CSPM 
...
::: details Learn More About Permissions
...
::: details Learn More About Identies Shared with Sysdig
### Identities
Two [AWS identities](https://docs.aws.amazon.com/IAM/latest/UserGuide/id.html){:target="_blank"} are required in the onboarding process:
