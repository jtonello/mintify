...
Follow the installation instructions in [Monitor Onboarding](/monitor/onboard/onboarding) to install Cluster Shield and Host Shield in your monitoring environment. They send system performance metrics and events to Sysdig Monitor, ensuring comprehensive visibility into your infrastructure. Review the requirements and select the installation path that best suits your setup.
