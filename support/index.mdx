...
<Tabs>
  <Tab title="Open a Ticket">
    ...
    <Tooltip tip="">lsb_release is part of a software package called the LSB core, which is not necessarily installed on your system by default. If it is not installed, see </Tooltip>https://wiki.itcollege.ee/index.php/Lsb_release<Tooltip tip="">.</Tooltip>
